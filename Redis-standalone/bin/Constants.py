...
STATE_FILE = DATA_HOME + "/state"
# KEEPALIVED_FILE = "/usr/local/keepalived/sbin/keepalived"
# KEEPALIVED_COPY_CONF_FILE = "/etc/keepalived/keepalived.copy.conf"
# KEEPALIVED_CONF_FILE = "/etc/keepalived/keepalived.conf"

DISABLE_ALL = "DISABLE_ALL"
DISABLE_COMMANDS = ["CONFIG", "BGREWRITEAOF", "BGSAVE", "DEBUG", "SAVE", "SHUTDOWN", "SLAVEOF","FLUSHALL","FLUSHDB","KEYS"]
